<template>
    <div
        :class="{'modal-field field-edit-text': true, 'validate-danger': isDangerField, 'validate-warning': isWarningField}"
    >
        <div v-if="title" class="field-title"
        ...
        <div class="field-value">
            <textarea
                ...
                v-focus="isFocused"
                :class="{'text-aria': true, 'danger': isDangerField, 'warning': isWarningField}"
                :placeholder="placeholder"
                :maxlength="validator ? validator.maxLength : 0"
                :rows="rowsQty"
                :disabled="disabled"
